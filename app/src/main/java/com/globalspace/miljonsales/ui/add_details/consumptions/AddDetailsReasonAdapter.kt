...
class AddDetailsReasonAdapter(
    private val lstdata: MutableList<FetchMolecule>,
    private val listener: AddDetailsDialogConsumptionAdapter.onItemConsumptionClick,
    private val strflag : String
) :
    RecyclerView.Adapter<AddDetailsReasonAdapter.ViewHolder>(), Filterable {
        ...
        with(holder) {
            ...
            holder.itemView.setOnClickListener {
                if (adapterPosition != RecyclerView.NO_POSITION)
                    listener.onItemConsumptionClick(
                        adapterPosition,
