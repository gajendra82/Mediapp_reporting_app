...
import com.globalspace.miljonsales.activity.DownloadsActivity;
import com.globalspace.miljonsales.activity.LeavesActivity;
...
public class FragmentAnalytics extends Fragment {
    ...
    private TextView selectDate, downarrow, callsPanned, targetCall, deviation, expectedAverage, actuallAverage,
            pob, monthlyCalls, downloads, tv_monthpob, monthlyDownloads, monthlyLeaves, tv_totaldeliverycount, tvapproved, tvpending, tvdecline, tvpostpone;
    private LinearLayout callsPlannedLL, actualAvgLL, pobLL, monthlyCallLL, downloadsLL, monthpobLL, monthlyDownloadLL, monthlyLeaveLL, deliveredLL, pendingLL, approvedLL, declineLL, postponeLL;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.analytics_layout, container, false);
            ...
            public void onClick(View v) {
                ...
                if (!callsPanned.getText().toString().equals("0")) {
                    ...
                    if (reportingDetails != null) {
                        Intent i = new Intent(getActivity(), CallDetails.class);
                        i.putExtra("Type", "Daily");
                        i.putExtra("ReportingData", reportingDetails);
                        startActivity(i);
                    }
                } else {
                    Toast.makeText(getActivity(), "No Reporting done", Toast.LENGTH_SHORT).show();
                }
                //endregion
            }
        });
        ...
        pobLL.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!pob.getText().toString().equals("0")) {
                    Intent i = new Intent(getActivity(), POBActivity.class);
                    i.putExtra("function_name", "getEmpTodayPOBDetail");
                    i.putExtra("date", SelectedDate);
                    i.putExtra("Type", "Daily");
                    i.putExtra("EmpId", sPref.getString(getString(R.string.employee_id), ""));
                    startActivity(i);
                } else {
                    Toast.makeText(getActivity(), "No pob placed", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        downloadsLL.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!downloads.getText().toString().equals("0")) {
                    ...
                    Toast.makeText(getActivity(), "No downloads for today", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        monthlyLeaveLL.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!monthlyLeaves.getText().toString().equals("0")) {
                    Intent i = new Intent(getActivity(), LeavesActivity.class);
                    i.putExtra("date", SelectedDate);
                    i.putExtra("EmpId", sPref.getString(getString(R.string.employee_id), ""));
                    startActivity(i);
                } else {
                    Toast.makeText(getActivity(), "No leaves applied", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void setContent() {
        sPref = getActivity().getSharedPreferences(getResources().getString(R.string.app_name), Context.MODE_PRIVATE);
        callsPlannedLL = (LinearLayout) v.findViewById(R.id.callsPlannedLL);
        actualAvgLL = (LinearLayout) v.findViewById(R.id.actualAvgLL);
        callsPanned = (TextView) v.findViewById(R.id.tvCallPlanned1);
        targetCall = (TextView) v.findViewById(R.id.targetCall);
        deviation = (TextView) v.findViewById(R.id.tvDeviation1);
        expectedAverage = (TextView) v.findViewById(R.id.tvExpectedAvg1);
        expectedAverage.setText("30.00");
        actuallAverage = (TextView) v.findViewById(R.id.tvActualAvg1);

        tvapproved = (TextView) v.findViewById(R.id.tvapproved);
        tvpending = (TextView) v.findViewById(R.id.tvpending);
        tvdecline = (TextView) v.findViewById(R.id.tvdecline);
        tvpostpone = (TextView) v.findViewById(R.id.tvpostpone);
        selectDate = (TextView) v.findViewById(R.id.date);
        downarrow = (TextView) v.findViewById(R.id.arrow_btn);
        downarrow.setTypeface(MiljonOffer.solidFont);

        approvedLL = (LinearLayout) v.findViewById(R.id.approvedLL);
        pendingLL = (LinearLayout) v.findViewById(R.id.pendingLL);
        declineLL = (LinearLayout) v.findViewById(R.id.declineLL);
        postponeLL = (LinearLayout) v.findViewById(R.id.postponeLL);

        monthlyCalls = (TextView) v.findViewById(R.id.tvMonthlyCall);
        monthlyCallLL = (LinearLayout) v.findViewById(R.id.monthlyCallLL);

        downloads = (TextView) v.findViewById(R.id.tvDownload);
        downloadsLL = (LinearLayout) v.findViewById(R.id.downloadsLL);

        monthlyDownloads = (TextView) v.findViewById(R.id.tvDownloadMonthly);
        monthlyDownloadLL = (LinearLayout) v.findViewById(R.id.downloadsMonthlyLL);

        monthpobLL=(LinearLayout) v.findViewById(R.id.monthpobLL);
        tv_monthpob = (TextView) v.findViewById(R.id.tv_monthpob);

        pob = (TextView) v.findViewById(R.id.tvPOB);
        pobLL = (LinearLayout) v.findViewById(R.id.pobLL);

        deliveredLL = (LinearLayout) v.findViewById(R.id.deliveredLL);
        tv_totaldeliverycount = (TextView) v.findViewById(R.id.tv_totaldeliverycount);
       /* monthlyPOB = (TextView) v.findViewById(R.id.tvPOBMonthly);
        monthlyPOBLL = (LinearLayout) v.findViewById(R.id.pobMonthlyLL);*/

        monthlyLeaveLL = (LinearLayout) v.findViewById(R.id.leavesLL);
        monthlyLeaves = (TextView) v.findViewById(R.id.tvLeaves);
    ...
    private void getData(String Date) {
        if (Internet.checkConnection(getActivity())) {
            ...
            Call<DashboardData> call = apiInterface.getDashboardData(function_name,
                    sPref.getString(getString(R.string.employee_id), ""), Date);
                    ...
                    if (response.isSuccessful()) {
                        if (progress.isShowing()) {
                            ...
                            if (response.body().getError().toString().equals("true")) {
                                ...
                                //Calls Planned
                                if (response.body().getTotalReportings() != null) {
                                ...
                                //Daily Target
                                if (response.body().getDailyTargetCalls() != null) {
