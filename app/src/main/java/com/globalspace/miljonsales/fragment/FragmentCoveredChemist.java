...
public class FragmentCoveredChemist extends Fragment {
    private View view;
    ...
    private List<ChemistInfo> allChemistList = new ArrayList<>();
    ...
    private void openAddMembersDialog() {
        ...
        campaignListAdapter = new CampaignListAdapter(getActivity(), allChemistList,"Covered Chemist");
            ...
            public void onClick(View v) {
                ...
                if (addMembersList.size() != 0) {
                    try {
                        ...
                        sendChemistList(data, "setMiljonEmpCheRel","Add");
    ...
    private void getCampaignMembersList() {
        ...
        progress.show();
        if (Internet.checkConnection(getActivity())) {
            Call<Login_Response> call = apiInterface.getChampEmpCheDetail("getMiljonEmpCheRel",
                ...
                public void onResponse(Call<Login_Response> call, Response<Login_Response> response) {
                    if (response.isSuccessful()) {
                        ...
                        Chemist_List_Adapter adapter = new Chemist_List_Adapter(getActivity(), campaignMembers,
                                ...
                                progress, "MATM_8","CoveredChemist");
